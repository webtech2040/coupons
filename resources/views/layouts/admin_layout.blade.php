...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('admin/vendor/jquery-nice-select/css/nice-select.css')}}">

    <link rel="stylesheet" type="text/css" href="{{asset('admin/vendor/nouislider/nouislider.min.css')}}">
...
<body>
				...
				<ul class="metismenu" id="menu">
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
							...
							<li><a href="{{route('dashboard_count')}}">Dashboard Count</a></li>
							</li>	
						</ul>
    ...
    ***********************************-->
     ...
     <script type="text/javascript" src="{{asset('admin/js/demo.js')}}"></script>
       ...
       <script type="text/javascript" src="{{asset('admin/js/styleSwitcher.js')}}"></script>




     <script type="text/javascript" src="{{asset('admin/vendor/global/global.min.js')}}"></script>


      <script type="text/javascript" src="{{asset('admin/vendor/chart.js/Chart.bundle.min.js')}}"></script>


       <script type="text/javascript" src="{{asset('admin/vendor/jquery-nice-select/js/jquery.nice-select.min.js')}}"></script>




       <script type="text/javascript" src="{{asset('admin/vendor/apexchart/apexchart.js')}}"></script>


      <script type="text/javascript" src="{{asset('admin/vendor/nouislider/nouislider.min.js')}}"></script>


       <script type="text/javascript" src="{{asset('admin/vendor/wnumb/wNumb.js')}}"></script>



       <script type="text/javascript" src="{{asset('admin/js/dashboard/dashboard-1.js')}}"></script>

       <script type="text/javascript" src="{{asset('admin/js/custom.min.js')}}"></script>


       <script type="text/javascript" src="{{asset('admin/js/dlabnav-init.js')}}"></script>
