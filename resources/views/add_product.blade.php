...
<div class="content-body">
 ...
 @endif
                            ...
                            <div class="card-body">
                                ...
                                <div class="basic-form">
                                    ...
                                    <form action="{{route('save_product')}}" method="POST">
                                        ...
                                        <div class="mb-3">
                                            <input type="text" class="form-control input-default " name="product_name"  placeholder="Enter Product Name">
                                        </div>
    ...
    @enderror
                                        ...
                                        <div class="mb-3">
                                            <input type="text" name="product_status" class="form-control input-rounded" placeholder="Enter Product Status">
                                        </div>
